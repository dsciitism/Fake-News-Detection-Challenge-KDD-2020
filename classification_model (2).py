    ...
    def train(
        ...
        **kwargs,
        ...
        for _ in train_iterator:
            ...
            train_losses=(tr_loss / global_step)
            eval_losses=results["eval_loss"]
            accuracy=results["acc"]
            print(f"Train_loss{train_losses},Val_loss={eval_losses},Accuracy={accuracy},lr={lrs}")
            with open('log.txt','a+') as f:
              f.writelines(f"Epoch:{epoch_number},Train_loss{train_losses},Val_loss={eval_losses},Accuracy={accuracy},lr={lrs}\n")

            print('Testing it too.......')
            print()
            ...
            submission.to_csv(f'submissionl{eval_losses:.3f}a{accuracy:.4f}.csv',index = False)
            epoch_number += 1
